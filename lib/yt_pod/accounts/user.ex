defmodule YTPod.Accounts.User do
  @moduledoc false

  use Ash.Resource,
    otp_app: :yt_pod,
    domain: YTPod.Accounts,
  ...
  alias YTPod.Accounts.User.Senders.SendMagicLinkEmail
  alias YTPod.Accounts.User.Senders.SendNewUserConfirmationEmail
  alias YTPod.Accounts.User.Senders.SendPasswordResetEmail
